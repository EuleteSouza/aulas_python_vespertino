...
lista_palavras = ['python', 'programação', 'computador', 'notebook', 'software', 'openai', 'algoritmos']

palavra = random.choice(lista_palavras) #palavra secreta
letras_corretas = []
letras_erradas = []
tentativas = 6
...
while True:
    ...
    letra_usuario = input('Digitar uma letra: ').lower()
